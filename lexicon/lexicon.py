LEXICON: dict[str: str] = {
    ...
    'error_add_expanses': '❌ Вы записываете расход в неправильном формате.\n'
                          ...
                          'чтобы выйти из режима записи',
    'cur_stat': '',
    'stat_selected_day': 'Выбрать день ✅',
    'stat_selected_date': 'Выбрать дату ✅',
    'selected_day': 'Напишите день в чат',
    'selected_date': 'Напишите дату в чат',
    'no_data': '❌ Нет данных за указанный день',
